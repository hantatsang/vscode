...
(function () {
	...
	// we know for a fact that workbench.native.main will depend on
	// the related CSS and NLS counterparts.
	bootstrapWindow.load([
		'vs/workbench/workbench.native.main',
		...
		function (_, configuration) {
			...
			// @ts-ignore
			return require('vs/workbench/electron-browser/native.main').main(configuration);
		},
		{
